...
pyinstaller --onefile --windowed --name MacroSuite --icon=..\assets\01_media\01_icons\icon.ico --distpath publish --workpath publish\build --specpath publish main\main.py
